...
const OK04MINTPAGEREFERRAL1 = (props) => {
             ...
             if(data_obtained == false){
               ...
               console.log(data_obtained);
                   ...
                   return(
                     ...
                     <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-container">
                       <Helmet>
                         <title>OK-04-MINT-PAGE-REFERRAL1 - AR Powered By ODlabs</title>
                         <meta
                           property="og:title"
                           content="OK-04-MINT-PAGE-REFERRAL1 - AR Powered By ODlabs"
                         />
                       </Helmet>
                       <header
                         data-role="Accordion"
                         className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-header"
                       >
                         <img
                           alt="logo"
                           src="/playground_assets/mz-1500h.png"
                           className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-image"
                         />
                         <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-separator"></div>
                         <nav className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-nav">
                         ...
                         <div
                           ...
                           className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-accordion-header"
                         >
                           <svg
                             viewBox="0 0 1024 1024"
                             className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-icon"
                           >
                         ...
                         <div
                           ...
                           className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-accordion-content"
                         >
                           <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-nav1">
                             <NavigationLinks rootClassName="rootClassName27"></NavigationLinks>
                           </div>
                         </div>
                         <button className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-button button">
                           ConnectWallet
                         </button>

                         <button className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-button2 button">
                           Reset
                         </button>
                       </header>
                     </div>
              ...
              if (data_obtained == true){
                        ...
                        console.log("data obtained tttt")
                        return (
                          ...
                          <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-container">
                            ...
                            <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-pricing">
                              <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-container1">
                                <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-pricing-card">
                                  <span className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-text">
                                    WHITELIST
                                  </span>


                                  {whitelist &&
                                        <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-container2">
                                          <ul className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-ul list">
                                            {renderlist()}
                                ...
                                {countPR &&
                                <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-pricing-card1">
                                  <ul className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-ul1 list">
                                  ...
                                  <ul className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-ul3 list">
                                  ...
                                  <li className="list-item"> 8 </li>
                                  <li className="list-item"> 9 </li>
                                  <li className="list-item"> 10 </li>
                                  <li className="list-item"> 11 </li>
                                  <li className="list-item"> 12 </li>
                                  <li className="list-item"> 13 </li>
                                  <li className="list-item"> 14 </li>
                                  <li className="list-item"> 15 </li>
                                  <li className="list-item"> 16 </li>
                                  <li className="list-item"> 17 </li>
                                  <li className="list-item"> 18 </li>
                                  <li className="list-item"> 19 </li>
                                  <li className="list-item"> 20 </li>
                                  <li className="list-item"> 21 </li>
                                  <li className="list-item"> 22 </li>
                                  <li className="list-item"> 23 </li>
                                  <li className="list-item"> 24 </li>
                                  <li className="list-item"> 25 </li>
                                  <li className="list-item"> 26 </li>
                                  <li className="list-item"> 27 </li>
                                  <li className="list-item"> 28 </li>
                                  <li className="list-item"> 29 </li>
                                  <li className="list-item"> 30 </li>

                                  </ul>
                                  <span className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-text10">
                                    PR DASHBOARD
                                  </span>
                                </div>
                              }
                                ...
                                <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-pricing-card2">
                                  <span className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-text11">
                                    <span className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-text12">
                                      REFERRAL INTERFACE
                                    </span>
                                    <br></br>
                                  </span>
                                    ...
                                    <br></br>
                                          <div>
                                            <input
                                              ...
                                              className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-textinput input"
                                              id="_ID_url"
                                              value={_ID_url}
                                            />
                                  ...
                                  <div>
                                          ...
                                          <div>
                                            <input
                                            type="text"
                                            placeholder="Enter Add. 2"
                                            className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-textinput1 input"
                                            id="_ID_url2"
                                            value={_ID_url2}
                                          />
                                          </div>
                                  ...
                                  <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-container3">
                                      <div >
                                        NFT COST: {nft_cost} eth
                                      </div>
                                  ...
                                  <button className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-button3 button" onClick={getTransactionResult_} >
                                    MINT
                                  </button>
                            ...
                            <footer className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-footer">
                              <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-container4">
                                <nav className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-nav2">
                                  <span className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-text17">
                                    TERM &amp; CONDITIONS
                                  </span>
                                  <span className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-text18">
                                    PRIVACY
                                  </span>
                                  <span className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-text19">
                                    LICENSE
                                  </span>
                                  <span className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-text20">
                                    NFT PURCHASE AGREEMENT
                                  </span>
                                </nav>
                              </div>
                              <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-separator1"></div>
                              <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-container5">
                                <span className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-text21">
                                  © 2023 ODLABS, All Rights Reserved.
                                </span>
                                <div className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-icon-group">
                                  <svg
                                    viewBox="0 0 950.8571428571428 1024"
                                    className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-icon2"
                                  >
                                  ...
                                  <svg
                                    ...
                                    className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-icon4"
                                  >
                                  ...
                                  <svg
                                    viewBox="0 0 1024 1024"
                                    className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-icon6"
                                  >
                                  ...
                                  <img
                                    ...
                                    className="o-k04m-i-n-t-p-a-g-e-r-e-f-e-r-r-a-l1-image1"
                                  />
                                </div>
                              </div>
                            </footer>
...
export default OK04MINTPAGEREFERRAL1
