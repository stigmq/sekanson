...
import './o-k-01-new-1-page-for-welcome-home.css'
...
const OK01New1PageForWelcomeHome = (props) => {
  ...
  console.log("not connected");
            ...
            return (
              <div className="o-k01new1page-for-welcome-home-container">
                <Helmet>
                  <title>OK-01-new-1-page-for-welcome-home - AR Powered By ODlabs</title>
                  <meta
                    property="og:title"
                    content="OK-01-new-1-page-for-welcome-home - AR Powered By ODlabs"
                  />
                </Helmet>
                <header
                  data-role="Accordion"
                  className="o-k01new1page-for-welcome-home-header"
                >
                  <img
                    alt="logo"
                    src="/playground_assets/mz-1500h.png"
                    className="o-k01new1page-for-welcome-home-image"
                  />
                  <div className="o-k01new1page-for-welcome-home-separator"></div>
                  <nav className="o-k01new1page-for-welcome-home-nav">
                  ...
                  <div
                    ...
                    className="o-k01new1page-for-welcome-home-accordion-header"
                  >
                    <svg
                      viewBox="0 0 1024 1024"
                      className="o-k01new1page-for-welcome-home-icon"
                    >
                  ...
                  <div
                    ...
                    className="o-k01new1page-for-welcome-home-accordion-content"
                  >
                    <div className="o-k01new1page-for-welcome-home-nav1">
                      <NavigationLinks rootClassName="rootClassName31"></NavigationLinks>
                    </div>
                  </div>
                  <button className="o-k01new1page-for-welcome-home-button button">
                    ConnectWallet
                  </button>

                  <button className="o-k01new1page-for-welcome-home-button2 button">
                    Reset
                  </button>
                </header>
                <div className="o-k01new1page-for-welcome-home-pricing">
                  <div className="o-k01new1page-for-welcome-home-container1"></div>
                </div>
                <footer className="o-k01new1page-for-welcome-home-footer">
                  <div className="o-k01new1page-for-welcome-home-container2">
                    <nav className="o-k01new1page-for-welcome-home-nav2">
                      <span className="o-k01new1page-for-welcome-home-text">
                        TERM &amp; CONDITIONS
                      </span>
                      <span className="o-k01new1page-for-welcome-home-text1">
                        PRIVACY
                      </span>
                      <span className="o-k01new1page-for-welcome-home-text2">
                        LICENSE
                      </span>
                      <span className="o-k01new1page-for-welcome-home-text3">
                        NFT PURCHASE AGREEMENT
                      </span>
                    </nav>
                  </div>
                  <div className="o-k01new1page-for-welcome-home-separator1"></div>
                  <div className="o-k01new1page-for-welcome-home-container3">
                    <span className="o-k01new1page-for-welcome-home-text4">
                      © 2023 ODLABS, All Rights Reserved.
                    </span>
                    <div className="o-k01new1page-for-welcome-home-icon-group">
                      <svg
                        viewBox="0 0 950.8571428571428 1024"
                        className="o-k01new1page-for-welcome-home-icon2"
                      >
                      ...
                      <svg
                        ...
                        className="o-k01new1page-for-welcome-home-icon4"
                      >
                      ...
                      <svg
                        viewBox="0 0 1024 1024"
                        className="o-k01new1page-for-welcome-home-icon6"
                      >
                      ...
                      <img
                        ...
                        className="o-k01new1page-for-welcome-home-image1"
                      />
                    </div>
                  </div>
                </footer>
...
export default OK01New1PageForWelcomeHome
