...
import './o-k-05-new-1-page-t-r-y-m-e.css'
...
const OK05New1PageTRYME = (props) => {
  ...
  return (
    <div className="o-k05new1page-t-r-y-m-e-container">
      <Helmet>
        <title>OK-05-new-1-page-TRY-ME - AR Powered By ODlabs</title>
        <meta
          property="og:title"
          content="OK-05-new-1-page-TRY-ME - AR Powered By ODlabs"
        />
      </Helmet>
      <header data-role="Accordion" className="o-k05new1page-t-r-y-m-e-header">
        <img
          alt="logo"
          src="/playground_assets/mz-1500h.png"
          className="o-k05new1page-t-r-y-m-e-image"
        />
        <div className="o-k05new1page-t-r-y-m-e-separator"></div>
        <nav className="o-k05new1page-t-r-y-m-e-nav">
        ...
        <div
          ...
          className="o-k05new1page-t-r-y-m-e-accordion-header"
        >
          <svg viewBox="0 0 1024 1024" className="o-k05new1page-t-r-y-m-e-icon">
            <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
          </svg>
        </div>
        <div
          data-role="AccordionContent"
          className="o-k05new1page-t-r-y-m-e-accordion-content"
        >
          <div className="o-k05new1page-t-r-y-m-e-nav1">
            <NavigationLinks rootClassName="rootClassName33"></NavigationLinks>
          </div>
        </div>
        <button className="o-k05new1page-t-r-y-m-e-button button">
          ConnectWallet
        </button>
        <button className="o-k05new1page-t-r-y-m-e-button1 button">
          Disconnect
        </button>
        <button className="o-k05new1page-t-r-y-m-e-button2 button">
          Reset
        </button>
      </header>
      <div className="o-k05new1page-t-r-y-m-e-pricing">
        <div className="o-k05new1page-t-r-y-m-e-container1">
          <img
            alt="image"
            src="/playground_assets/svs-600h.webp"
            className="o-k05new1page-t-r-y-m-e-image1"
          />
          <img
            alt="image"
            src="/playground_assets/svs-600h.webp"
            className="o-k05new1page-t-r-y-m-e-image2"
          />
        </div>
      </div>
      <footer className="o-k05new1page-t-r-y-m-e-footer">
        <div className="o-k05new1page-t-r-y-m-e-container2">
          <nav className="o-k05new1page-t-r-y-m-e-nav2">
            <span className="o-k05new1page-t-r-y-m-e-text">
              TERM &amp; CONDITIONS
            </span>
            <span className="o-k05new1page-t-r-y-m-e-text1">PRIVACY</span>
            <span className="o-k05new1page-t-r-y-m-e-text2">LICENSE</span>
            <span className="o-k05new1page-t-r-y-m-e-text3">
              NFT PURCHASE AGREEMENT
            </span>
          </nav>
        </div>
        <div className="o-k05new1page-t-r-y-m-e-separator1"></div>
        <div className="o-k05new1page-t-r-y-m-e-container3">
          <span className="o-k05new1page-t-r-y-m-e-text4">
            © 2023 ODLABS, All Rights Reserved.
          </span>
          <div className="o-k05new1page-t-r-y-m-e-icon-group">
            <svg
              viewBox="0 0 950.8571428571428 1024"
              className="o-k05new1page-t-r-y-m-e-icon2"
            >
            ...
            <svg
              ...
              className="o-k05new1page-t-r-y-m-e-icon4"
            >
            ...
            <svg
              ...
              className="o-k05new1page-t-r-y-m-e-icon6"
            >
            ...
            <img
              ...
              className="o-k05new1page-t-r-y-m-e-image3"
            />
          </div>
        </div>
      </footer>
...
export default OK05New1PageTRYME
